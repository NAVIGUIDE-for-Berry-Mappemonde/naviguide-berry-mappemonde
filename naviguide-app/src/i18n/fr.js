...
export default {
  ...
  score:              "Score",
  briefing:           "BRIEFING",
  briefingFreshness:  "Généré le {{date}} · {{remaining}}",
  briefingRefreshIn:  "rafraîchir dans {{remaining}}",
  briefingExpired:    "rafraîchi bientôt",
  ...
  wavePopupTitle:      "Vagues",
  waveHeight:          "Hauteur significative",
  wavePeriod:          "Période",
  waveDirection:       "Direction",
  currentPopupTitle:   "Courant",
  currentSpeedLabel:   "Vitesse",
  currentDirectionLabel: "Direction",
  noData:              "Aucune donnée disponible",
  portCountry:     "Pays",
  portUnnamed:     "Port sans nom",
  layerBalisage:   "Buoyage",
  layerBalisageTitle: "Balisage maritime (OpenSeaMap)",
  layerMpas:       "MPAs",
  layerMpasTitle:  "Aires Marines Protégées (ProtectedSeas Navigator)",
  layerProjects:      "Projets",
  layerProjectsTitle: "Projets Blue Intelligence",
  projectsSeeMore:    "Voir le projet ↗",
  layersLabel:     "Couches",
